...
function changeModel() {
  let currentModel = document.getElementById("model-text");
  if (modelName === "XYZ") {
    modelName = "CPRG";
...
function changeDuration() {
  var currentDuration = document.getElementById("duration-text");
  duration = parseInt(prompt("Please enter a duration (days): "));
